...
grayavg2=mean2(lena);
grayavg11=threshold(elain,0.1); %预迭代法阈值
grayavg22=threshold(lena,0.1);
figure(1)
subplot(1,2,1);im2bw(elain,grayavg1/255);title('elain图像分割');
subplot(1,2,2);im2bw(lena,grayavg2/255);title('lena图像分割');
figure(2)
subplot(1,2,1);im2bw(elain,grayavg11/255);title('elain图像分割');
subplot(1,2,2);im2bw(lena,grayavg22/255);title('lena图像分割');
```
